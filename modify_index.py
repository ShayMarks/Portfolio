...
content = re.sub(r'class="btn btn-primary"', 'class="btn btn-primary bg-transparent text-primary border-2 border-primary py-3 px-8 rounded-full hover:bg-primary hover:text-white transition-all shadow-[0_0_15px_rgba(48, 92, 222,0.3)] hover:shadow-[0_0_25px_rgba(48, 92, 222,0.6)]"', content)
...
content = content.replace('class="portfolio-item"', 'class="portfolio-item relative overflow-hidden rounded-2xl bg-cardbg ring-1 ring-white/10 shadow-2xl transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_rgba(48, 92, 222,0.2)]"')
...
content = content.replace('class="skills-filter', 'class="skills-filter px-5 py-2 m-2 rounded-full border border-primary text-sm backdrop-blur-sm transition-all hover:bg-primary hover:text-white shadow-[0_0_10px_rgba(48, 92, 222,0.1)]')
